...
import 'package:flutter_template/manager_ui/manager_products/allProducts/addProductsController.dart';
...
class managerAddProductScreen extends StatelessWidget {
  ...
  Widget _buildImagePicker(ManagerAddProductController controller) {
    return Center(
      child: Column(
        children: [
          Obx(() {
  ...
  Widget _buildPriceSection(ManagerAddProductController controller) {
    return Card(
      color: secondaryColor.withOpacity(0.2),
      elevation: 0,
  ...
  Widget _buildSimplePriceFields(ManagerAddProductController controller) {
    return Padding(
  ...
  Widget _buildVariationPriceFields(ManagerAddProductController controller) {
    return Obx(() => Column(
          children: [
  ...
  Widget _buildVariationGroup(
      ManagerAddProductController controller, VariationGroup group, int index) {
    return Padding(
  ...
  Widget _buildStatusSelector(ManagerAddProductController controller) {
    return Obx(() => Row(
  ...
  Widget _buildActionButtons(
      ManagerAddProductController controller, bool isEditMode) {
