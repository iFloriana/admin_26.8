...
class ManagerCustomerProfileScreen extends StatelessWidget {
  ManagerCustomerProfileScreen({super.key, required this.customer});
  ...
  Future<List<dynamic>> fetchVisitHistory() async {
    ...
    try {
      final response = await dioClient.getData(
        '${Apis.baseUrl}/customers/visit-history/${customer.id}?salon_id=${loginUser!.manager?.salonId}',
