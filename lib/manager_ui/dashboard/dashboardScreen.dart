...
class ManagerDashboardScreen extends StatelessWidget {
  ...
  Widget performce_widget(managerDashboardController controller) {
  ...
  Widget lineChart(managerDashboardController controller) {
  ...
  Widget upcomming_booking(managerDashboardController controller) {
    final dashboard = controller.dashboardData.value;
  ...
  Widget combinedChart(managerDashboardController controller) {
  ...
  Widget total_revenue(managerDashboardController controller) {
    final dashboard = controller.dashboardData.value;
