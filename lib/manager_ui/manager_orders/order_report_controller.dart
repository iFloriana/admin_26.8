...
class ManagerOrderReportController extends GetxController {
  ...
  void applyFilters() {
    ...
    if (selectedDateRange.value != null) {
      filtered = filtered.where((order) {
        ...
        return (orderDateNormalized.isAtSameMomentAs(startDateNormalized) ||
                orderDateNormalized.isAfter(startDateNormalized)) &&
            (orderDateNormalized.isAtSameMomentAs(endDateNormalized) ||
                orderDateNormalized.isBefore(endDateNormalized));
      }).toList();
    }
  ...
  Future<void> getOrderReports() async {
    ...
    try {
      final response = await dioClient.getData(
           '${Apis.baseUrl}/order/by-branch?salon_id=${loginUser?.manager?.salonId}&branch_id=${loginUser?.manager?.branchId?.sId}',
        (json) {
      ...
      print(
          '${Apis.baseUrl}${Endpoints.orderReport}?salon_id=${loginUser?.manager?.salonId}');
