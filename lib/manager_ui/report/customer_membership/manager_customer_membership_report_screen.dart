...
class ManagerCustomerMembershipReportScreen extends StatelessWidget {
  ManagerCustomerMembershipReportScreen({super.key});
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Obx(() {
          ...
          if (controller.customerMemberships.isEmpty) {
            return const Center(child: Text('No customers with memberships.'));
          }
          if (controller.filteredCustomerMemberships.isEmpty) {
            return const Center(
          ...
          return SingleChildScrollView(
            ...
            child: SingleChildScrollView(
              ...
              child: DataTable(
                ...
                rows: controller.filteredCustomerMemberships.expand((customer) {
                  return (customer['package_and_membership'] as List)
                    ...
                    final discount =
                        '${details['discount']} ${details['discount_type'] == 'percentage' ? '%' : ''}';
                    return DataRow(cells: [
                      ...
                      DataCell(Text(details['membership_name'] ?? '')),
                      DataCell(Text(details['subscription_plan'] ?? '')),
  ...
  void _showExportDialog(BuildContext context,
      ManagerCustomerMembershipReportController controller) {
    showDialog(
      context: context,
  ...
  String _getAppBarTitle(ManagerCustomerMembershipReportController controller) {
    String title = 'Customer Membership Report';
