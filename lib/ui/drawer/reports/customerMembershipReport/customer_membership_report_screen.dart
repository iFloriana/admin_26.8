...
class CustomerMembershipReportScreen extends StatelessWidget {
  CustomerMembershipReportScreen({super.key});
  ...
  void _showExportDialog(BuildContext context,
      CustomerMembershipReportController controller) {
    showDialog(
      context: context,
  ...
  String _getAppBarTitle(CustomerMembershipReportController controller) {
